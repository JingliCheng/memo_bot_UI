...
const DebugIcon = () => (
  ...
  >
    ...
    <path d="M15 2v4" />
    <path d="M9 6h6" />
    <path d="M9 6c-2 0-3 1-3 3v6c0 2 1 3 3 3h6c2 0 3-1 3-3V9c0-2-1-3-3-3" />
...
function App() {
    ...
    if (searchQuery.trim() && !isLoading && isAuthenticated) {
      ...
      try {
        await sendChatMessage(
          ...
          // onRawOutput - called for raw output updates
          (rawOutput) => {
            setRawOutput(rawOutput);
          }
        );
  ...
  /**
   * Handles ProfileCard toggle
   */
  const handleProfileCardToggle = () => {
    setShowProfileCard(!showProfileCard);
    console.log('ProfileCard toggled:', !showProfileCard);
  };

  /**
   * Handles DebugToggle toggle
   */
    ...
    <div className="App">
      ...
      <header className="header">
        ...
        <div className="header-icons">
          ...
          <button 
            className={`icon-button toggle-button ${showProfileCard ? 'active' : ''}`}
          ...
          <button 
            className={`icon-button toggle-button ${showDebugToggle ? 'active' : ''}`}
      ...
      <main className="main-content fade-in">
        <div className={`content-layout ${showMemoryPeek || showRecentMessages || showProfileCard || showDebugToggle ? 'with-sidebar' : 'centered'}`}>
          ...
          <div className="sidebar">
            ...
            {showDebugToggle && <DebugToggle 
              isVisible={showDebugToggle}
              rawOutput={rawOutput}
